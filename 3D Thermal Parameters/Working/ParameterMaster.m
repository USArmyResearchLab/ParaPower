function [master,envmaster,georow,envrow,delta_t,transteps,bmatmaster,matpropsmaster,tranmin] = ParameterMaster(para,envdata,sides,x,y,z,basestatus,basedata,bmat,NL,matlist,matprops,matparatype)
...
idx=find(contains(para(:,1),'Transient'));
if idx>0
