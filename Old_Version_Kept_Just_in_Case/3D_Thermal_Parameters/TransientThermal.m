function [Tres, Stress] = TransientThermal(NL,NR,NC,h,Ta,dx,dy,dz,Tproc,Mat,Q,delta_t,steps,T_init,matprops)
% [Tres, Stress] = TransientThermal(NL,NR,NC,h,Ta,dx,dy,dz,kond,cte,E,nu,Tproc,Mat,Q,delta_t,rho,spht,steps,T_init)
...
% AIR=[0.024 55e-6 2.5e9 0.3 1.225 0]
...
T_init=zeros(NR,NC,NL)+T_init; % Sets initial nodal temperatures to 20
