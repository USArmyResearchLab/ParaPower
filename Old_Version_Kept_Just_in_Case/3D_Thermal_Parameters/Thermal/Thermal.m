...
Tproc=280;
dx=[.002 .008 .002 .006 .002 0.002 .008 .002]; % Column width vector, m, load value for each column
...
smax=max(Stress(:))
% for i=1:NL
%     xlswrite('ConfirmStress23.xlsx',Stress(:,:,i),i)
%     xlswrite('ConfirmTemp23.xlsx',Tres(:,:,i),i)
% end
