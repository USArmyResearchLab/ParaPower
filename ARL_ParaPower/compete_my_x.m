if 1
%load('ipack.mat','ipack_11_11_7','ipack_10cases','ipack_10x')

%n_case = length(ipack_10cases);
n_case = length(ipack_10x);
%n_case = 3
...
save('compete_10xsize.mat','result_size','result_time')
end
...
legend('Seq(x)','Vec(x)','Location','Northwest')
xlabel('Data size')
ylabel('Time (s)')
title('Scaling in X')
