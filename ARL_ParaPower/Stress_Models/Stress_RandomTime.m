function a = Stress_RandomTime(Results)
...
% corresponding time
% time varies sinusoidally: = Asin(Bx+C)+D
% B is frequency (# of cycles in 2pi)
% to get 2 cycles per total time, B = 4pi/time
    ...
    for h=1:x_size;
        ...
        for i=1:y_size
            ...
            for j=1:z_size
                ...
                mat_loc_val(h,i,j,t) = (material_number(h,i,j) + one_x_normalized*one_y_normalized*one_z_normalized)*time(t);
            end
        end
    end
end
