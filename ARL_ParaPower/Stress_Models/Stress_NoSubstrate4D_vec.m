...
% dimension
%
function [stressx, stressy, stressz, stressvm] = Stress_NoSubstrate4D_vec (Results)
...
% common numerator and denominator in all the matrices
% common_num = youngs_time ./ (ones_4D - poisson_time);
% common_den = (cte_time.*delT + ones_4D);
% natrix_nx = common_num .* d_Y .* d_Z;
