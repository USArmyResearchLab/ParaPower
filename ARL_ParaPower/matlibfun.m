...
Al=[172 23.5e-6 69e9 0.33 2700 900 0 0 0 0 0 inf]; %Aluminum Material Data
Cu=[390 24e-6 110e9 0.37 8900 390 0 0 0 0 0 inf]; %Copper Materail Data
AlN=[170 5.3e-6 344e9 0.24 3260 740 0 0 0 0 0 inf]; %Aluminum Nitride Material Data
SiC=[120 4e-6 410e9 0.14 3100 750 0 0 0 0 0 inf]; %Silicon Carbide Material Data
EN=[0.1 55e-6 2.5e9 0.3 0 0 0 0 0 0 0 inf]; %Encapsulent Material Data
Ga=[33.7 0 0 0 5903 340 1 24 6093 397 80300 29.8]; %Galium Material Data
Chip=[1.14 0 0 0 2230 753.12 0 0 0 0 0 inf];
Alumina=[25 0 0 0 3720 880 0 0 0 0 0 inf];
AIR=[0.024 100 0 0 1.225 0 0 0 0 0 0 inf];
Pyrex = [1.2 0 0 0 2200 830 0 0 0 0 0 inf];
Mike_Plastic = [1 0 0 0 1000 3000 0 0 0 0 0 inf];
