...
Desc='3D Bidirctnl';  %Description of the test case

ExternalConditions.h_Xminus=15000;
ExternalConditions.h_Xplus =25000;
ExternalConditions.h_Yminus=15000;
ExternalConditions.h_Yplus =25000;
ExternalConditions.h_Zminus=15000;
...
Features(end).z    = 0.005+[1 1]*min(Features(end-1).z);
Features(end).dz   = 1;
Features(end).Q    = 1;
...
Features(end).x    = 0.005+[1 1]*min(Features(end-1).x);
Features(end).dx   = 1;
...
Features(end+1)      = Features(end);
Features(end).y    = 0.005+[1 1]*min(Features(end-1).y);;
Features(end).dy   = 1;
Features(end).Q    = Features(2).Q;
Features(end).Matl = 'No_Matl';
